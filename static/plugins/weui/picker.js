! function(a) {
    ...
    "use strict";
    var b = function(b) {
        function g() { var b = !1; return c.params.convertToPopover || c.params.onlyInPopover ? (!c.inline && c.params.input && (c.params.onlyInPopover ? b = !0 : a.device.ios ? b = a.device.ipad ? !0 : !1 : a(window).width() >= 768 && (b = !0)), b) : b }

        function h() { return c.opened && c.container && c.container.length > 0 && c.container.parents(".popover").length > 0 ? !0 : !1 }
        ...
        function k(b) { h() || (c.input && c.input.length > 0 ? b.target !== c.input[0] && 0 === a(b.target).parents(".weui-picker-modal").length && c.close() : 0 === a(b.target).parents(".weui-picker-modal").length && c.close()) }

        function l() { c.opened = !1, c.input && c.input.length > 0 && c.input.parents(".page-content").css({ "padding-bottom": "" }), c.params.onClose && c.params.onClose(c), c.container.find(".picker-items-col").each(function() { c.destroyPickerCol(this) }) }
        var e, f, c = this,
            d = { updateValuesOnMomentum: !1, updateValuesOnTouchmove: !0, rotateEffect: !1, momentumRatio: 7, freeMode: !1, scrollToInput: !0, inputReadOnly: !0, toolbar: !0, toolbarCloseText: "完成", title: "请选择", toolbarTemplate: '<div class="toolbar">          <div class="toolbar-inner">          <a href="javascript:;" class="picker-button close-picker">{{closeText}}</a>          <h1 class="title">{{title}}</h1>          </div>          </div>' };
        b = b || {};
        for (e in d) "undefined" == typeof b[e] && (b[e] = d[e]);
        return c.params = b, c.cols = [], c.initialized = !1, c.inline = c.params.container ? !0 : !1, f = a.device.ios || navigator.userAgent.toLowerCase().indexOf("safari") >= 0 && navigator.userAgent.toLowerCase().indexOf("chrome") < 0 && !a.device.android, c.setValue = function(a, b) { var e, d = 0; for (e = 0; e < c.cols.length; e++) c.cols[e] && !c.cols[e].divider && (c.cols[e].setValue(a[d], b), d++) }, c.updateValue = function() {
            var e, b = [],
                d = [];
            ...
            function r() { q = a.requestAnimationFrame(function() { h.updateItems(void 0, void 0, 0), r() }) }
            ...
            function H() { var d, e, f; return t && u ? (t = u = !1, h.wrapper.transition(""), A && ("min" === A ? h.wrapper.transform("translate3d(0," + n + "px,0)") : h.wrapper.transform("translate3d(0," + o + "px,0)")), y = (new Date).getTime(), y - x > 300 ? e = B : (d = Math.abs(D / (y - E)), e = B + D * c.params.momentumRatio), e = Math.max(Math.min(e, o), n), f = -Math.floor((e - o) / l), c.params.freeMode || (e = -f * l + o), h.wrapper.transform("translate3d(0," + parseInt(e, 10) + "px,0)"), h.updateItems(f, e, "", !0), c.params.updateValuesOnMomentum && (r(), h.wrapper.transitionEnd(function() { a.cancelAnimationFrame(q) })), setTimeout(function() { s = !0 }, 100), void 0) : (t = u = !1, void 0) }
            ...
            }, h.calcSize(), h.wrapper.transform("translate3d(0," + o + "px,0)").transition(0), h.setValue = function(b, d, e) { var f, g; "undefined" == typeof d && (d = ""), f = h.wrapper.find('.picker-item[data-picker-value="' + b + '"]').index(), "undefined" != typeof f && -1 !== f && (g = -f * l + o, h.wrapper.transition(d), h.wrapper.transform("translate3d(0," + g + "px,0)"), c.params.updateValuesOnMomentum && h.activeIndex && h.activeIndex !== f && (a.cancelAnimationFrame(q), h.wrapper.transitionEnd(function() { a.cancelAnimationFrame(q) }), r()), h.updateItems(f, g, d, e)) }, h.updateItems = function(b, d, e, g) {
                var i, j;
        ...
        }, c.destroyPickerCol = function(b) { b = a(b), "f7DestroyPickerCol" in b[0] && b[0].f7DestroyPickerCol() }, a(window).on("resize", i), c.columnHTML = function(a, b) {
            var e, c = "",
                d = "";
        ...
        }, c.close = function() { return c.opened && !c.inline ? h() ? (a.closePicker(c.popover), void 0) : (a.closePicker(c.container), void 0) : void 0 }, c.destroy = function() { c.close(), c.params.input && c.input.length > 0 && c.input.off("click focus", j), a("html").off("click", k), a(window).off("resize", i) }, c.inline && c.open(), c
    };
    a(document).on("click", ".close-picker", function() {
        ...
        a.preventDefault()
    }), a.openPicker = function(b, c) { var d, e; return a.closePicker(), d = a("<div class='weui-picker-container " + (c || "") + "'></div>").appendTo(document.body), d.show(), d.addClass("weui-picker-container-visible"), e = a(b).appendTo(d), e.width(), e.addClass("weui-picker-modal-visible"), e }, a.closePicker = function() { a(".weui-picker-modal-visible").removeClass("weui-picker-modal-visible").transitionEnd(function() { a(this).parent().remove() }).trigger("close") }, a.fn.picker = function(c) {
        var d = arguments;
        ...
        return c = a.extend({}, b, c), this.each(function() {
            ...
            this && (b = new Date, d = function(a) {
                ...
                var c = new Date(b, parseInt(a) + 1 - 1, 1),
                    e = new Date(c - 1);
                return d(e.getDate())
            }, f = function(a) { return 10 > a ? "0" + a : a }, g = function(a) { return 0 == c.m ? a[0] + c.dateSplit + a[1] + c.dateSplit + a[2] + " " + a[3] + c.timeSplit + a[4] : 1 == c.m ? a[0] + c.dateSplit + a[1] + c.dateSplit + a[2] : void 0 }, h = "01 02 03 04 05 06 07 08 09 10 11 12".split(" "), i = function() { var b, a = []; for (b = 1950; 2030 >= b; b++) a.push(b); return a }(), 0 == c.m ? (k = [b.getFullYear(), f(b.getMonth() + 1), f(b.getDate()), f(b.getHours()), f(b.getMinutes())], l = [{ values: i }, { values: h }, { values: d() }, { divider: !0, content: " " }, { values: function() { var b, a = []; for (b = 0; 23 >= b; b++) a.push(f(b)); return a }() }, { divider: !0, content: ":" }, { values: function() { var b, a = []; for (b = 0; 59 >= b; b++) a.push(f(b)); return a }() }]) : 1 == c.m && (k = [b.getFullYear(), f(b.getMonth() + 1), f(b.getDate())], l = [{ values: i }, { values: h }, { values: d() }]), m = {
                rotateEffect: !1,
                value: k,
                ...
                formatValue: function(a, b, c) { return g(b, c) },
                cols: l
